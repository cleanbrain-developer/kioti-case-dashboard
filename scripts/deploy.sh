...
for ctr in kioti-db kioti-backend kioti-frontend kioti-smtp \
           kioti-case-dashboard-db kioti-case-dashboard-backend kioti-case-dashboard-frontend kioti-case-dashboard-smtp; do
